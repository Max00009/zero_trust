...
def image_cleaner(filepath):
    ...
    result=(_lib.image_cleaner(filepath_bytes,ctypes.c_bool(change_filesys_date),ctypes.c_bool(change_internal_date),ctypes.c_bool(replace_original))).decode('utf-8')
    return result